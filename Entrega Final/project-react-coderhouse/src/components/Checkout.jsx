...
const Checkout = () => {
  const { cart, clearCart, totalProducts, sumProducts } =
          ...
          <div className="col text-center">
            {orderId ? (
              <div className="alert alert-light p-5" role="alert">
                <p>
                  <img src="/images/bag.svg" alt="Carrito" width={80} />
                </p>
                <h3>Gracias por tu compra!</h3>
                <p>
                  Tu Número de Compra es: <b>{orderId}</b>
                </p>
                <Link to={"/"} className="btn btn-dark rounded-pill mt-5">
    ...
    return (
      <div className="container my-5">
        <div className="row">
          <div className="col text-center">
            <p>
              <img src="/img/carrito.png" alt="Carrito" width={80} />
            </p>
                ...
                {cart.map((item) => (
                  <tr key={item.id}>
                    <td className="align-middle">
                      <img src={item.image} alt={item.title} width={72} />
                    </td>
